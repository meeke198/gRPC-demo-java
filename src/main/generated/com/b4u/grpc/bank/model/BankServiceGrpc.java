package com.b4u.grpc.bank.model;
...
public final class BankServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.b4u.grpc.bank.model.BalanceCheckRequest,
      com.b4u.grpc.bank.model.Balance> getGetBalanceMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getBalance",
      requestType = com.b4u.grpc.bank.model.BalanceCheckRequest.class,
      responseType = com.b4u.grpc.bank.model.Balance.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.b4u.grpc.bank.model.BalanceCheckRequest,
      com.b4u.grpc.bank.model.Balance> getGetBalanceMethod() {
    io.grpc.MethodDescriptor<com.b4u.grpc.bank.model.BalanceCheckRequest, com.b4u.grpc.bank.model.Balance> getGetBalanceMethod;
      ...
      synchronized (BankServiceGrpc.class) {
        if ((getGetBalanceMethod = BankServiceGrpc.getGetBalanceMethod) == null) {
          BankServiceGrpc.getGetBalanceMethod = getGetBalanceMethod =
              io.grpc.MethodDescriptor.<com.b4u.grpc.bank.model.BalanceCheckRequest, com.b4u.grpc.bank.model.Balance>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "getBalance"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.b4u.grpc.bank.model.BalanceCheckRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.b4u.grpc.bank.model.Balance.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.b4u.grpc.bank.model.WithdrawRequest,
      com.b4u.grpc.bank.model.Money> getWithdrawMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "withdraw",
      requestType = com.b4u.grpc.bank.model.WithdrawRequest.class,
      responseType = com.b4u.grpc.bank.model.Money.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<com.b4u.grpc.bank.model.WithdrawRequest,
      com.b4u.grpc.bank.model.Money> getWithdrawMethod() {
    io.grpc.MethodDescriptor<com.b4u.grpc.bank.model.WithdrawRequest, com.b4u.grpc.bank.model.Money> getWithdrawMethod;
    if ((getWithdrawMethod = BankServiceGrpc.getWithdrawMethod) == null) {
      synchronized (BankServiceGrpc.class) {
        if ((getWithdrawMethod = BankServiceGrpc.getWithdrawMethod) == null) {
          BankServiceGrpc.getWithdrawMethod = getWithdrawMethod =
              io.grpc.MethodDescriptor.<com.b4u.grpc.bank.model.WithdrawRequest, com.b4u.grpc.bank.model.Money>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "withdraw"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.b4u.grpc.bank.model.WithdrawRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.b4u.grpc.bank.model.Money.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.b4u.grpc.bank.model.DepositRequest,
      com.b4u.grpc.bank.model.Balance> getCashDepositMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "cashDeposit",
      requestType = com.b4u.grpc.bank.model.DepositRequest.class,
      responseType = com.b4u.grpc.bank.model.Balance.class,
      methodType = io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
  public static io.grpc.MethodDescriptor<com.b4u.grpc.bank.model.DepositRequest,
      com.b4u.grpc.bank.model.Balance> getCashDepositMethod() {
    io.grpc.MethodDescriptor<com.b4u.grpc.bank.model.DepositRequest, com.b4u.grpc.bank.model.Balance> getCashDepositMethod;
      ...
      synchronized (BankServiceGrpc.class) {
        if ((getCashDepositMethod = BankServiceGrpc.getCashDepositMethod) == null) {
          BankServiceGrpc.getCashDepositMethod = getCashDepositMethod =
              io.grpc.MethodDescriptor.<com.b4u.grpc.bank.model.DepositRequest, com.b4u.grpc.bank.model.Balance>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "cashDeposit"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.b4u.grpc.bank.model.DepositRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.b4u.grpc.bank.model.Balance.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void getBalance(com.b4u.grpc.bank.model.BalanceCheckRequest request,
        io.grpc.stub.StreamObserver<com.b4u.grpc.bank.model.Balance> responseObserver) {
     ...
     * </pre>
     */
    default void withdraw(com.b4u.grpc.bank.model.WithdrawRequest request,
        io.grpc.stub.StreamObserver<com.b4u.grpc.bank.model.Money> responseObserver) {
     ...
     * </pre>
     */
    default io.grpc.stub.StreamObserver<com.b4u.grpc.bank.model.DepositRequest> cashDeposit(
        io.grpc.stub.StreamObserver<com.b4u.grpc.bank.model.Balance> responseObserver) {
  ...
  public static final class BankServiceStub
     ...
     * </pre>
     */
    public void getBalance(com.b4u.grpc.bank.model.BalanceCheckRequest request,
        io.grpc.stub.StreamObserver<com.b4u.grpc.bank.model.Balance> responseObserver) {
     ...
     * </pre>
     */
    public void withdraw(com.b4u.grpc.bank.model.WithdrawRequest request,
        io.grpc.stub.StreamObserver<com.b4u.grpc.bank.model.Money> responseObserver) {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<com.b4u.grpc.bank.model.DepositRequest> cashDeposit(
        io.grpc.stub.StreamObserver<com.b4u.grpc.bank.model.Balance> responseObserver) {
  ...
  public static final class BankServiceBlockingStub
     ...
     * </pre>
     */
    public com.b4u.grpc.bank.model.Balance getBalance(com.b4u.grpc.bank.model.BalanceCheckRequest request) {
     ...
     * </pre>
     */
    public java.util.Iterator<com.b4u.grpc.bank.model.Money> withdraw(
        com.b4u.grpc.bank.model.WithdrawRequest request) {
  ...
  public static final class BankServiceFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.b4u.grpc.bank.model.Balance> getBalance(
        com.b4u.grpc.bank.model.BalanceCheckRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_BALANCE:
          serviceImpl.getBalance((com.b4u.grpc.bank.model.BalanceCheckRequest) request,
              (io.grpc.stub.StreamObserver<com.b4u.grpc.bank.model.Balance>) responseObserver);
          break;
        case METHODID_WITHDRAW:
          serviceImpl.withdraw((com.b4u.grpc.bank.model.WithdrawRequest) request,
              (io.grpc.stub.StreamObserver<com.b4u.grpc.bank.model.Money>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        ...
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncServerStreamingCall(
            new MethodHandlers<
              com.b4u.grpc.bank.model.WithdrawRequest,
              com.b4u.grpc.bank.model.Money>(
                service, METHODID_WITHDRAW)))
        .addMethod(
          getCashDepositMethod(),
          io.grpc.stub.ServerCalls.asyncClientStreamingCall(
            new MethodHandlers<
              com.b4u.grpc.bank.model.DepositRequest,
              com.b4u.grpc.bank.model.Balance>(
  ...
  private static abstract class BankServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.b4u.grpc.bank.model.BankProto.getDescriptor();
    }
